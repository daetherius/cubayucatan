...
class AppModel extends Model {
	...
	function __construct($id = false, $table = null, $ds = null){
		...
		$defaultlabels = array(
			...
			'descripcion_ita'=>'descripción (Italiano)',
			'descripcion_esp'=>'descripción (Español)',
			'subtitulo_ita'=>'subtítulo (Italiano)',
			'subtitulo_esp'=>'subtítulo (Español)',
			'intro_ita'=>'texto introductorio (Italiano)',
			'intro_esp'=>'texto introductorio (Español)',
			'nombre_ita'=>'nombre (Italiano)',
			'nombre_esp'=>'nombre (Español)',
			'layout'=>'disposición',
			'email'=>'E-Mail',
			'src'=>'archivo'
		);
			...
			foreach($results as $idx => $result){
				...
				if($ipfields){
					foreach($ipfields as $ipf){
						if(isset($result[$this->alias][$ipf]) && $result[$this->alias][$ipf]){
