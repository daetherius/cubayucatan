...
-- Tiempo de generación: 27-11-2012 a las 18:43:36
...
(2, 'Cuba', 'Quale moneta conviene portare?', '', '<p>L&rsquo;euro va benissimo ovviamente, come le principali monete, ad eccezione dei dollari USA, che vengono tassati al 10% al momento del cambio</p>', '', 1, '2012-10-25 13:31:53', 1),
(3, 'Cuba', 'Sono valide tutte le carte di credito?', '', '<p>Le principali s&iacute;, come Mastercard, Visa ecc, &nbsp;ad eccezione di quelle provenienti dagli USA, come American Express. Il prelievo di contanti in banca con carta di credito &eacute; tassato all&rsquo;11%.</p>', '', 2, '2012-10-25 13:32:22', 1),
(4, 'Cuba', 'Quali monete sono in uso a Cuba?', '', '<p>A Cuba esistono due monete: il Peso cubano nazionale e il Peso cubano convertibile. Quest&rsquo;ultimo &eacute; quello che vi daranno quando cambierete i vostri soldi. Attenzione, il Convertibile, detto CUC, vale 24 Pesos Nazionali.</p>', '', 3, '2012-10-25 13:32:51', 1),
(5, 'Cuba', 'Come posso riconoscere le banconote delle due monete?', '', '<p>Entrate nel sito <a href="http://www.cubacurrency.com/">www.cubacurrency.com</a>:&nbsp; l&iacute; troverete le fotografie delle due banconote e il cambio con la vostra moneta, giorno per&nbsp; giorno. Il cambio &eacute; sempre leggermente diverso da quello che vi applicheranno.</p>', '', 4, '2012-10-25 13:33:11', 1),
(6, 'Cuba', 'Dove posso cambiare il denaro?', '', '<p>Nelle sedi del Banco de Cr&eacute;dito y de Comercio, e in quelle delle Cadeca, Casas de Cambio.</p>', '', 5, '2012-10-25 13:34:45', 1),
(7, 'Cuba', 'Posso portare il cellulare?', '', '<p>S&iacute;, senza problemi. Attenzione: assolutamente proibiti i telefoni satellitari.</p>', '', 6, '2012-10-25 13:35:06', 1),
(8, 'Cuba', 'Cuba &eacute; un posto sicuro?', '', '<p>Cuba &eacute; uno dei posti pi&uacute; sicuri al mondo. Si pu&oacute; andare in giro tranquillamente, sempre usando il buon senso di evitare luoghi troppo appartati e oscuri, come in qualsiasi posto del mondo. Quando sarete fuori dalle Case dove alloggiate, attenzione a macchine fotografiche, denaro, gioielli eccetera.</p>', '', 7, '2012-10-25 13:35:30', 1),
(9, 'Cuba', 'Sono necessarie vaccinazioni?', '', '<p>Nessuna vaccinazione &eacute; necessaria.</p>', '', 8, '2012-10-25 13:35:51', 1),
(10, 'Cuba', '&Eacute; necessaria un&rsquo;assicurazione di viaggio?', '', '<p>S&iacute;, e il costo &eacute; di USD 2.50, al giorno e per persona. Vi sar&aacute; fornita al momento di comprare il volo. Non perdetela, o la dovrete ripagare.</p>', '', 9, '2012-10-25 13:36:08', 1),
(11, 'Cuba', 'Per visitare Cuba, occorre il visto d&rsquo;entrata?', '', '<p>S&iacute;, e vi sar&aacute; fornito anch&rsquo;esso con il biglietto aereo. Fate attenzione a non perderlo, perch&eacute; vi sar&aacute; richiesto all&rsquo;uscita dal Paese.</p>', '', 10, '2012-10-25 13:36:27', 1),
(12, 'Yucatan', 'Quanti chili di bagaglio posso portare?', '', '<p>Quelli consentiti dalla vostra Compagnia aerea. Non portare &nbsp;liquidi contenuti in bottiglie&nbsp; o contenitori non sigillati.&nbsp;</p>', '', 11, '2012-11-01 16:52:37', 1),
(13, 'Yucatan', 'Quale moneta conviene portare?', '', '<p>Qualunque moneta, non ci sono restrizioni.&nbsp;</p>', '', 12, '2012-11-01 16:52:55', 1),
(14, 'Yucatan', 'Sono valide tutte le carte di credito?', '', '<p>S&iacute;, tutte.</p>', '', 23, '2012-11-01 16:53:27', 1),
(15, 'Yucatan', 'Quali monete sono in uso in Messico?', '', '<p>Il Peso messicano, che potete acquistare in qualsiasi Banca</p>', '', 19, '2012-11-01 16:53:45', 1),
(16, 'Yucatan', 'Dove posso cambiare il denaro?', '', '<p>In qualsiasi Banca, presentando il passaporto. Cambiate il denaro preferibilmente nelle banche, e non nei cambiavalute sulla strada: il cambio &eacute; pi&uacute; favorevole per voi. Potete consultare il cambio con l&rsquo;Euro o altre monete, come il Franco Svizzero, in qualsiasi sito specializzato in divise.&nbsp;Qui a fianco, trovate un bottone&nbsp;per verificare i cambi.</p>', '', 13, '2012-11-01 16:54:03', 1),
(17, 'Yucatan', 'Yucat&aacute;n &eacute; un posto sicuro?', '', '<p>Assolutamente tranquillo e sicuro. Con le precauzioni che usereste in qualsiasi posto del mondo.</p>', '', 21, '2012-11-01 16:54:18', 1),
(18, 'Yucatan', 'Sono necessarie vaccinazioni?', '', '<p>Nessuna vaccinazione &eacute; necessaria.</p>', '', 15, '2012-11-01 16:54:33', 1),
(19, 'Yucatan', '&Eacute; necessaria un&rsquo;assicurazione di viaggio?', '', '<p>Non &eacute; necessaria.</p>', '', 16, '2012-11-01 16:54:48', 1),
(20, 'Yucatan', 'Per visitare lo Yucat&aacute;n, occorre il visto d&rsquo;entrata?', '', '<p>In linea generale, per gli Europei non serve il visto.</p>', '', 31, '2012-11-01 16:55:06', 1),
(21, 'Cuba', 'Occorre pagare qualcosa in aereoporto, all&#039;uscita dal Paese?', '', '<p>Dopo il check-in, e prima del controllo passaporti, bisogna pagare CUC 25 a persona come imposta aereoportuale.</p>', '', 26, '2012-11-12 17:29:30', 1),
(22, 'General', 'In che modo possiamo ricevere assistenza  in caso di problemi? ', '', '<p>Contattando direttamente gli amministratori del sito:</p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;Telefoni: 0052 999 2855910</p>\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 0052 999 588175&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="mailto:umberto@cubayucatan.mx">umberto@cubayucatan.mx</a></p>\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="mailto:edelis@cubayucatan.mx">edelis@cubayucatan.mx</a></p>\r\n<p>&nbsp;</p>\r\n<p>Comunque, per quanto riguarda Cuba, potete rivolgervi per qualsiasi problema ai gerenti delle Case, e avrete l&rsquo;assicurazione medica fin dalla partenza, all&rsquo;acquisto del biglietto aereo.</p>\r\n<p>In Yucat&aacute;n invece, sarete titolari di assicurazione personale, con telefono&nbsp; cellulare per mettervi in contatto con gli uffici predisposti.</p>', '', 14, '2012-11-14 09:40:38', 1),
(23, 'General', 'Quando riceveremo il Voucher, dopo aver pagato?', '', '<p>Immediatamente dopo aver verificato l&rsquo;arrivo del pagamento, tenendo conto della differenza oraria con l&rsquo;Italia (7 ore), e all&rsquo;indirizzo di posta elettronica che ci invierete con la prenotazione.&nbsp;</p>', '', 18, '2012-11-14 09:41:42', 1),
(24, 'General', 'I prezzi possono subire modifiche con il variare dei cambi fra le monete?', '', '<p>S&iacute;, sia per quanto riguarda il Peso convertibile cubano che il Peso messicano. Modificheremo automaticamente i prezzi in caso di variazioni, sia in rialzo che in ribasso. Nel sito avete a disposizione un bottone cambiavalute.</p>', '', 25, '2012-11-14 09:42:14', 1),
(25, 'General', 'Dove si trova la Societ&aacute; che gestisce il sito?', '', '<p>La Societ&aacute; &eacute; la NUOVA G&Eacute;NESIS SRL de CV, Calle 70 n. 581/A, por 77&nbsp; y&nbsp; 79, M&eacute;rida Centro, Yucat&aacute;n, M&eacute;xico</p>\r\n<p>La societ&aacute; &eacute; regolarmente registrata presso le seguenti Istituzioni messicane:</p>\r\n<p>Secretar&iacute;a de Hacienda, con il Codice RFC ( Partita IVA ): NGE 080305 ETA</p>\r\n<p>Secretar&iacute;a de Turismo de Yucat&aacute;n.</p>\r\n<p>Ayuntamiento de la Ciudad de M&eacute;rida.</p>', '', 27, '2012-11-14 09:42:38', 1),
(26, 'General', 'Chi sono e dove vivono gli Amministratori della Societ&aacute; e del sito?', '', '<p>Gli Amministratori sono:</p>\r\n<p>Edelis Albolaez Valdivia&nbsp; e Umberto Fioroni</p>\r\n<p>Edelis &eacute; cubana e Umberto vive da molti anni a Cuba e in Yucat&aacute;n, all&rsquo;indirizzo della Societ&aacute; che trovate qui sopra</p>', '', 17, '2012-11-14 09:43:13', 1),
(27, 'General', 'Che cosa significa Mayataan  e  Mayakoot', '', '<p>Mayataan significa Casa dei Maya, e Mayakoot&nbsp; Confine dei Maya. Ek Balam significa Giaguaro Nero.</p>', '', 24, '2012-11-14 09:43:31', 1),
(28, 'General', 'E Ek Balam?', '', NULL, NULL, 22, '2012-11-19 09:15:37', 1),
(29, 'General', 'Che cosa sono le Casas Particulares?', '', '<p>Sono case private, occupate da famiglie cubane, che hanno chiesto e ottenuto dal governo la licenza per affittare stanze ai turisti</p>', '', 20, '2012-11-14 09:44:17', 1),
...
(31, 'General', 'Che vantaggi ricavo dalla permanenza in Casas Particulares rispetto agli Alberghi?', '', '<p>Le Casas Particulares sono molto pi&uacute; a buon mercato degli Alberghi.</p>\r\n<p>Inoltre, offrono lo splendido vantaggio di farvi vivere a stretto contatto con la vita quotidiana dei cubani, sia della famiglia che vi ospita che dei loro amici e vicini di quartiere.</p>\r\n<p>Non sono necessarie mance (se l&rsquo;iniziativa verr&aacute; da voi, ovviamente sar&aacute; ben accetta)</p>\r\n<p>I gerenti delle Case sono molto gentili e selezionati in anni di lavoro. Curano in modo speciale la pulizia e sono disponibili ad aiutarvi in qualsiasi modo inc aso sorgessero problemi.</p>', '', 28, '2012-11-14 09:44:55', 1),
(32, 'General', 'Quali  sono i vostri dati bancari?', '', '<p>Umberto Fioroni<br />Banco: Scotiabank<br />Sucursal: 001, Plaza 170, M&eacute;rida, Yucat&aacute;n, M&eacute;xico<br />Cuenta: 17001027751<br />Codigo Swift: MBCOMXMM</p>', '<p>Umberto Fioroni<br />Banco: Scotiabank<br />Sucursal: 001, Plaza 170, M&eacute;rida, Yucat&aacute;n, M&eacute;xico<br />Cuenta: 17001027751<br />Codigo Swift: MBCOMXMM</p>', 29, '2012-11-23 12:42:27', 1);
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `email` varchar(255) NOT NULL,
  `forma_pago` enum('deposito','online') NOT NULL,
  ...
  `opcion_llegada_yucatan` enum('no','si','si_independiente') default NULL,
  `taxi_arribo` date default NULL,
  `taxi_hora` time default NULL,
