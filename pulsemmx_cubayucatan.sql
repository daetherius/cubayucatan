...
-- Tiempo de generación: 26-10-2012 a las 23:51:12
...
INSERT INTO `faqs` (`id`, `nombre_ita`, `nombre_esp`, `descripcion_ita`, `descripcion_esp`, `orden`, `created`, `activo`) VALUES
(1, 'Quanti chili di bagaglio posso portare?', '', '<p>30 kilogrammi a persona. Fate attenzione, a sorpassare il peso consentito, perch&eacute; la dogana cubana, in caso di controlli, vi far&aacute; pagare 10 Pesos convertibili per kilogrammo ( circa&nbsp; Euro 8)&nbsp;</p>', '', 1, '2012-10-25 13:31:16', 1),
(2, 'Quale moneta conviene portare?', '', '<p>L&rsquo;euro va benissimo ovviamente, come le principali monete, ad eccezione dei dollari USA, che vengono tassati al 10% al momento del cambio</p>', '', 2, '2012-10-25 13:31:53', 1),
(3, 'Sono valide tutte le carte di credito?', '', '<p>Le principali s&iacute;, come Mastervard, Visa ecc, &nbsp;ad eccezione di quelle provenienti dagli USA, come American Express. Il prelievo di contanti in banca con carta di credito &eacute; tassato all&rsquo;11%.</p>', '', 3, '2012-10-25 13:32:22', 1),
(4, 'Quali monete sono in uso a Cuba?', '', '<p>A Cuba esistono due monete: il Peso cubano nazionale e il Peso cubano convertibile. Quest&rsquo;ultimo &eacute; quello che vi daranno quando cambierete i vostri soldi. Attenzione, il Convertibile, detto CUC, vale 24 Pesos Nazionali.</p>', '', 4, '2012-10-25 13:32:51', 1),
(5, 'Come posso riconoscere le banconote delle due monete?', '', '<p>Entrate nel sito <a href="http://www.cubacurrency.com/">www.cubacurrency.com</a>:&nbsp; l&iacute; troverete le fotografie delle due banconote e il cambio con la vostra moneta, giorno per&nbsp; giorno. Il cambio &eacute; sempre leggermente diverso da quello che vi applicheranno.</p>', '', 5, '2012-10-25 13:33:11', 1),
(6, 'Dove posso cambiare il demaro?', '', '<p>Nelle sedi del Banco de Cr&eacute;dito y de Comercio, e in quelle delle Cadeca, Casas de Cambio.</p>', '', 6, '2012-10-25 13:34:45', 1),
(7, 'Posso portare il cellulare?', '', '<p>S&iacute;, senza problemi. Attenzione: assolutamente proibiti i telefoni satellitari.</p>', '', 7, '2012-10-25 13:35:06', 1),
(8, 'Cuba &eacute; un posto sicuro?', '', '<p>Cuba &eacute; uno dei posti pi&uacute; sicuri al mondo. Si pu&oacute; andare in giro tranquillamente, sempre usando il buon senso di evitare luoghi troppo appartati e oscuri, come in qualsiasi posto del mondo. Quando sarete fuori dalle Case dove alloggiate, attenzione a macchine fotografiche, denaro, gioielli eccetera.</p>', '', 8, '2012-10-25 13:35:30', 1),
(9, 'Sono necessarie vaccinazioni?', '', '<p>Nessuna vaccinazione &eacute; necessaria.</p>', '', 9, '2012-10-25 13:35:51', 1),
(10, '&Eacute; necessaria un&rsquo;assicurazione di viaggio?', '', '<p>S&iacute;, e il costo &eacute; di USD 2.50, al giorno e per persona. Vi sar&aacute; fornita al momento di comprare il volo. Non perdetela, o la dovrete ripagare.</p>', '', 10, '2012-10-25 13:36:08', 1),
(11, 'Per visitare Cuba, occorre il visto d&rsquo;entrata?', '', '<p>S&iacute;, e vi sar&aacute; fornito anch&rsquo;esso con il biglietto aereo. Fate attenzione a non perderlo, perch&eacute; vi sar&aacute; richiesto all&rsquo;uscita dal Paese.</p>', '', 11, '2012-10-25 13:36:27', 1);
